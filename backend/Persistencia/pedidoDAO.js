...
export default class PedidoDao {
    ...
    async consultarTodos() {
        ...
        const sql = `SELECT p.codigo, p.cliente_codigo, p.data_pedido, p.total,
                    ...
                    prod.liv_codigo, prod.liv_nome, prod.liv_precoCusto, prod.liv_precoVenda, prod.liv_dataCompra, prod.liv_qtdEstoque,
                    ...
                    INNER JOIN livro as prod ON prod.liv_codigo = i.produto_codigo
        ...
        for (const registro of registros) {
            ...
            const produto = new Livro(registro.liv_codigo, registro.liv_nome, registro.liv_precoCusto, registro.liv_precoVenda, registro.liv_dataCompra, registro.liv_qtdEstoque, autor);
    ...
    async consultar(termoBusca) {
        ...
        if (!isNaN(termoBusca)) { //assegurando que seja um código de pedido do tipo inteiro
            ...
            const sql = `SELECT p.codigo, p.cliente_codigo, p.data_pedido, p.total,
                        ...
                        INNER JOIN cliente as c ON p.cliente_codigo = c.codigo
                        INNER JOIN pedido_produto as i ON i.pedido_codigo = p.codigo
                        INNER JOIN livro as prod ON prod.produto_codigo = i.produto_codigo
                        INNER JOIN autor as aut ON prod.aut_codigo = aut.aut_codigo
                        WHERE p.codigo = ?`;
